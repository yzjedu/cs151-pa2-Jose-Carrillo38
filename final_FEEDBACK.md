...
- There are three functions in this program, but none of the designs are reflected on the final design file. 
- This code feels like it is written by an AI. If you could prove to me that you have written this code by yourself, then I am willing to upgrade your grade. 
- Players loses is not properly outputed when the game is over. 
### Grade: R
